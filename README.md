...
초기 프로토타입 검토 때 아래 5가지를 먼저 확인하면, 개발 후반 접근성 수정 비용을 줄일 수 있습니다.
...
- [ ] **200% 확대**: 브라우저 200% 확대에서도 내용 잘림/겹침 없이 사용 가능한지
- [ ] **다크 모드 대응**: 텍스트-배경 대비가 유지되고 상태(hover/focus/disabled)가 구분되는지
